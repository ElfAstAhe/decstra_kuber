...
cd ./docker/integrations.fake/v1.0.0
sudo docker build -t elfastahe/integrations.fake:v1.0.0 .
cd ../../..
...
cd ./docker/calculations.calc02/v1.0.0
sudo docker build -t elfastahe/calculations.calc02:v1.0.0 .
cd ../../..
...
cd ./docker/publications.periodic/v1.0.0
sudo docker build -t elfastahe/publications.periodic:v1.0.0 .
cd ../../..