...
cd ./docker/integrations/v1.1.1
sudo docker build -t elfastahe/integrations:v1.1.1 .
cd ../../..
...
cd ./docker/calculations/v1.0.1
sudo docker build -t elfastahe/calculations:v1.0.1 .
cd ../../..
...
cd ./docker/publications/v1.0.1
sudo docker build -t elfastahe/publications:v1.0.1 .
cd ../../..
